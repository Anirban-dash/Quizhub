                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="user-photo m-b-30">
                          <img class="img-fluid" src="uploads/<?php echo $image['file_name'] ?>" alt="" /><br />
                        </div>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="1">
                              <div class="contact-information">
                                ...
                                <div class="phone-content my-1">
                                  ...
                                  <span class="phone-number"><?php echo $user['mobile'] ?></span>
                                </div>
                                <div class="address-content my-1">
                                  <span class="contact-title">Address:</span>
                                  <span class="mail-address"><?php echo $user['address'] ?></span>
                                </div>
                                <div class="email-content my-1">
                                  <span class="contact-title">Email:</span>
                                  <span class="contact-email"><?php echo $user['email'] ?></span>
                                </div>
                              </div>
                                ...
                                <div class="card-body">
                                  <div class="row">
                                    <div class="col-lg-12 col-sm-4">
                                      <span class="bar" data-peity='{ "fill": ["#13DAFE", "#6164C1","#19ad9f"]}'>1,1,1</span>
                                    </div>
